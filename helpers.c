    ...
    for (int i = 0; i < height; i++)
    {
        for (int j = 0; j < width; j++)
        {
            ...
            else if(i == height - 1)
            {
                ...
                image [i][j].rgbtGreen =  round((float)copyimage [i][j].rgbtGreen + (float) copyimage [i-1][j-1].rgbtGreen + (float) copyimage [i-1][j].rgbtGreen + (float) copyimage [i-1][j+1].rgbtGreen + (float) copyimage [i][j-1].rgbtGreen)/6;
            ...
            {
                image [i][j].rgbtRed =  round((float)copyimage [i][j].rgbtRed + (float) copyimage [i+1][j].rgbtRed + (float) copyimage [i-1][j].rgbtRed + (float) copyimage [i+1][j-1].rgbtRed + (float) copyimage [i-1][j-1].rgbtRed + (float) copyimage [i+1][j].rgbtRed)/6;
                image [i][j].rgbtGreen =  round((float)copyimage [i][j].rgbtGreen + (float) copyimage [i+1][j].rgbtGreen + (float) copyimage [i-1][j].rgbtGreen + (float) copyimage [i+1][j-1].rgbtGreen + (float) copyimage [i-1][j-1].rgbtGreen + (float) copyimage [i+1][j].rgbtGreen)/6;
                image [i][j].rgbtBlue =  round((float)copyimage [i][j].rgbtBlue + (float) copyimage [i+1][j].rgbtBlue + (float) copyimage [i-1][j].rgbtBlue + (float) copyimage [i+1][j-1].rgbtBlue + (float) copyimage [i-1][j-1].rgbtBlue + (float) copyimage [i+1][j].rgbtBlue)/6;
            }
            else
            {
